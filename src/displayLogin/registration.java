...
public class registration extends MyPanel{
	...
	public registration(ActionListener packageListener){
	...
	private void displayNorth() {
		lblHeader = new MyLabel("Sign Up Form", Size.defaultLblSubTitleFontSize);
	...
	private void displayCenter() {
		...
		lblEditName = new MyLabel("Name:", Size.defaultLblFontSize);
	...
	private void displaySouth() {
		...
		btnSave.setName("Login_LoginAdminPanel");
