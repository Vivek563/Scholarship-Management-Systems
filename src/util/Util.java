...
public class Util {
	...
	private final String studentFormat = "UID,Email,Password,Name,Faculty,GPA,Year of study,Type of study,Department,Applied to,Accepted to,Won";
	private final String adminFormat = "UID,Email,Password,Name";
